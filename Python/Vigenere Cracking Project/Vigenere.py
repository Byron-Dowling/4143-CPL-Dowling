...
Name: 
    ...
    ***Examples terminal commands to run the program***
        ...
        run = "python3 Vigenere.py input_file=VCT3.txt output_file=decrypted.txt operation=Decrypt encryption_key=none"
    ...
    *** Encryption Example***
        ...
        Operation: Encrypt
        Plaintext Message: HELLO CAN YOU PLEASE WEAR THIS BOMB VEST THANK YOU
        Key: MACHINE

        Repeated Key:      MACHI NEM ACH INEMAC HINE MACH INEM ACHI NEMAC HIN
        Plaintext Message: HELLO CAN YOU PLEASE WEAR THIS BOMB VEST THANK YOU
        Encrypted Message: TENSW PEZ YQB XYIMSG DMNV FHKZ JBQN VGZB GLMNM FWH
